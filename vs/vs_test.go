...
func TestVSConfig_GetTermRows(t *testing.T) {
	tests := []struct {
		name     string
		vsConfig *VSConfig
		want     int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.vsConfig.GetTermRows(); got != tt.want {
				t.Errorf("VSConfig.GetTermRows() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestVSConfig_SetTermRows(t *testing.T) {
	type args struct {
		rows int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.vsConfig.SetTermRows(tt.args.rows)
		})
	}
}

func TestVSConfig_GetTermCols(t *testing.T) {
	tests := []struct {
		name     string
		vsConfig *VSConfig
		want     int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.vsConfig.GetTermCols(); got != tt.want {
				t.Errorf("VSConfig.GetTermCols() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestVSConfig_SetTermCols(t *testing.T) {
	type args struct {
		cols int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.vsConfig.SetTermCols(tt.args.cols)
		})
	}
}
