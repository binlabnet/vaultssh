...
func TestGetTermRows(t *testing.T) {
	type args struct {
		vsapi VsApi
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GetTermRows(tt.args.vsapi); got != tt.want {
				t.Errorf("GetTermRows() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestSetTermRows(t *testing.T) {
	type args struct {
		vsapi VsApi
		rows  int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			SetTermRows(tt.args.vsapi, tt.args.rows)
		})
	}
}

func TestGetTermCols(t *testing.T) {
	type args struct {
		vsapi VsApi
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GetTermCols(tt.args.vsapi); got != tt.want {
				t.Errorf("GetTermCols() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestSetTermCols(t *testing.T) {
	type args struct {
		vsapi VsApi
		cols  int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			SetTermCols(tt.args.vsapi, tt.args.cols)
		})
	}
}
